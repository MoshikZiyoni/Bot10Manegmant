...
const Dashboard = () => {
  ...
  const barChartData = stats ? [
    ...
    { name: 'Busy', calls: stats.busyCalls, fill: brandColors.busyPurple },
    { name: 'Canceled', calls: stats.canceledCalls, fill: brandColors.canceledOrange },
  ] : [];
